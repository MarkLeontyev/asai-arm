"""Набор unit-тестов для модуля АСАИ АРМ.

Покрывает производственный флоу (взятие/завершение/брак/невозможно),
защиту менеджерских действий, ограничение на одну активную задачу у оператора,
а также домен "мои задачи".
"""
